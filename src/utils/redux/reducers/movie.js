...
const movieReducer = (state = initialState, {type, payload}) => {
  switch (type) {
    ...
    case actions.FETCH_ALL_MOVIE_GENRE + actions.PENDING:
      return {
        ...state,
        isPending: true,
      };
    case actions.FETCH_ALL_MOVIE_GENRE + actions.REJECTED:
      return {
        ...state,
        isPending: false,
        isRejected: true,
    ...
    case actions.FETCH_ALL_MOVIE_GENRE + actions.FULFILLED:
      if (payload.status === 200) {
        return {
          ...state,
          isPending: false,
          isFulfilled: true,
          genre: payload.data.genres,
          // status: payload.data.data.msg,
        };
      } else {
        return {
    ...
    case actions.GET_MOVIE_BY_GENRE + actions.PENDING:
      return {
        ...state,
        isPending: true,
      };
    case actions.GET_MOVIE_BY_GENRE + actions.REJECTED:
      return {
        ...state,
        isPending: false,
        isRejected: true,
    ...
    case actions.GET_MOVIE_BY_GENRE + actions.FULFILLED:
      return {
        ...state,
        movieByGenre: payload.data.results,
        isPending: false,
        isRejected: true,
        isFulfilled: true,
        // status: payload.data.data.msg,
